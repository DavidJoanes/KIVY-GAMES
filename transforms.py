...
def transform_perspective(self, x, y):
    ...
    # proportion_y = diff_y / self.perspective_point_y # 1, when diff_y == self.perspective_point_y and 0, when diff_y == 0
    ...
    factor_y = diff_y / self.perspective_point_y  # 1, when diff_y == self.perspective_point_y and 0, when diff_y == 0
